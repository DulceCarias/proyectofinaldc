...
<html lang="en">
  ...
  <br><br><br><br>
    <center>
          ...
          <div style='color:#Hex_RGB;'> <div class="btn btn-outline"> </div>
              ...
              <form action="validar.php" method="POST">
                ...
                <br>
                  ...
                  <center><div class="d-grip gap-2">
                    <button class="btn btn-outline-warning btn-lg btn-block" type="submit" name="enviar">Aceptar</button>
                  </form>
            </div>
          </div>
        </center>
<br><br><br>
  ...
  <button class="btn btn-info"  type="button">PBX: 89644005 - Direcion: 9-60, 6A Avenida, Cdad. de Guatemala   - Carnet:2020-40093 - Nombre: Dulce Maria Carias Orantes</button>
</div>
