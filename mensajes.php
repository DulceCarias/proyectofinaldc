...
<html lang="en">
  ...
  <body>
  <video src="img/M99.mp4" autoplay loop >
    </video>
    ...
    <div class="container">
      ...
      <div class="btn-group w-100" role="group" aria-label="Basic exaple">
          ...
          <button type="button" class="btn btn-dark"><a href="tiendas.php">Tiendas</a></button>
  ...
  <div class="container">
    ...
    <tr>
    <td><?php echo $row ['nomensajes'] ?> </td>  
    <td><?php echo $row ['Nombre'] ?> </td>
    <td><?php echo $row ['Telefono'] ?> </td>
    <td><?php echo $row ['correo'] ?> </td>
    <td><?php echo $row ['mensajes'] ?> </td>
    <td>
    </td>
    </tr>
    <?php } ?>
